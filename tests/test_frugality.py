...
from rank_comparia.frugality import calculate_frugality_score, get_models_output_tokens


data = pl.read_parquet("tests/data/test_data.parquet")


def test_models_output_tokens():
...
def test_calculate_frugal_score():
